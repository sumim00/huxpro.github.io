---
layout:       post
title:        "[CSS] grid 레이아웃 정리 (1) 부모 요소 속성"
...
![grid 크로스 브라우징](../img/in-post/2019/0125_img01.jpg)
...
![grid 예시](../img/in-post/2019/0125_img02.jpg)
...
```css
.container {
    grid-template-columns: 100px 50px auto; /* 열 크기는 순서대로 100px, 50px, 자동으로 지정한다  */
    grid-template-rows: repeat(2, 1fr) /* 행 너비는 1fr씩 2행으로 지정한다 */
}
```
...
![grid 예시](../img/in-post/2019/0125_img04.jpg)
